...
window.onload = function() {
    ...
    const defaultMainCategoryId = 1; // 페이지 접속 시 카테고리 1로 설정
...
<body>
	...
	<div class="col-10">
		...
		<div class="row mt-2">
			<div class="col"></div>
			<div class="col-10">
				<form action="/safari/auction/registerProductProcess" method="post" enctype="multipart/form-data">
					
					
					<div class="row mb-3">
					  	<label class="form-label">대분류 카테고리</label>
					  	
						 <select id="mainCategoryDropdown" onchange="getProductSubcategories()">
					...
					<div class="row mb-3">
					  	<label class="form-label">소분류 카테고리</label>
					  		<select id="subCategoryDropdown" name="auction_sub_category_id">
					  		</select>
					</div>					
					...
					<div class="row mb-3">
						...
						<textarea class="form-control" name="description" rows="5"				
							placeholder="제품에 대해 쉽게 이해할 수 있도록 자세히 작성해주세요"></textarea>				
					</div>			
