	    ...
	    <div class="container">
	      ...
	      <div class="d-flex flex-wrap justify-content-lg-between align-items-center">
	      	<div class="d-flex align-items-center">
	      		<h1 class="me-5"><a href="#" class="btn">LOGO(사파리)</a></h1>
	      	...
	      	<div class="d-flex flex-wrap">
		        ...
		        <ul class="nav justify-content-center mx-3">
		          <li class="me-4"><a href="../used/mainPage" class="nav-link px-2 link-body-emphasis">중고</a></li>
		          <li class="me-4"><a href="../rental/mainPage" class="nav-link px-2 link-body-emphasis">대여</a></li>
		          <li class="me-4"><a href="../auction/mainPage" class="nav-link px-2 link-body-emphasis">경매</a></li>
		          <li class="me-3"><a href="../community/mainPage" class="nav-link px-2 link-body-emphasis">커뮤니티</a></li>
		        </ul>
