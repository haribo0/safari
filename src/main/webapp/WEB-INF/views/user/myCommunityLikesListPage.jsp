						...
						<div class = "row mt-3">
							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="pick-tab-pane" role="tabpanel" aria-labelledby="pick-tab" tabindex="0">		
									<div class= "row mt-1 ">
										<c:if test="${empty pickByMyLikePost}">
											<div class = "col">
												아직 좋아요한 게시글이 없습니다.
											</div>
										</c:if>
							 			<c:forEach items="${pickByMyLikePost}" var="map" varStatus="status"> 
										<div class = "col">
								...
								<div class="tab-pane fade" id="help-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">	
									<div class= "row mt-1 ">
										<c:if test="${empty helpByMyLikePost}">
											<div class = "col">
												아직 좋아요한 게시글이 없습니다.
											</div>
										</c:if>
							  			<c:forEach items="${helpByMyLikePost}" var="map" varStatus="status"> 
										<div class = "col">
											<div class = "row mb-4 mx-0 card border border-1" style = "width: 500px;">
												<div class = "col">
													<div class = "row">
								...
								<div class="tab-pane fade" id="question-tab-pane" role="tabpanel" aria-labelledby="question-tab" tabindex="0">
									<div class= "row mt-1 ">
										<c:if test="${empty questionByMyLikePost}">
											<div class = "col">
												아직 좋아요한 게시글이 없습니다.
											</div>
										</c:if>
								<c:forEach items="${questionByMyLikePost}" var="map" varStatus="status">   
										<div class = "col">
											<div class = "row mb-4 mx-0 card border border-1" style = "width: 500px;" >
												<div class = "col">
													<div class = "row">
								...
								<div class="tab-pane fade" id="recruit-tab-pane" role="tabpanel" aria-labelledby="recruit-tab" tabindex="0">
									<div class= "row mt-1 ">
										<c:if test="${empty recruitByMyLikePost}">
											<div class = "col">
												아직 좋아요한 게시글이 없습니다.
											</div>
										</c:if>
							 			<c:forEach items="${recruitByMyLikePost}" var="map" varStatus="status"> 
										<div class = "col">
											<div class = "row mb-4 mx-0 card border border-1" style = "width: 500px;" >
												<div class = "col">
													<div class = "row">
								...
								<div class="tab-pane fade" id="proreview-tab-pane" role="tabpanel" aria-labelledby="proreview-tab" tabindex="0">
									<div class= "row mt-1 ">
										<c:if test="${empty proreviewByMyLikePost}">
											<div class = "col">
												아직 좋아요한 게시글이 없습니다.
											</div>
										</c:if>
										<c:forEach items="${proreviewByMyLikePost}" var="map" varStatus="status"> 
										<div class = "col">
											<div class = "row mb-4 mx-0 card border border-1" style = "width: 500px;" >
												<div class = "col">
													<div class = "row">
