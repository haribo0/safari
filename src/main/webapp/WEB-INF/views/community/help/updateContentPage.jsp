...
<%--수정하기 폼 시작 --%>
	<div class="container">
		<table class="table table-hover">
			<tbody>
				<tr>
	  				<td><input type="hidden" name="id" value="${map.helpDto.id}"></td>
	  			</tr>
				<tr>
					<td><input type="text" class="form-control" name="title" maxlength="40" value="${map.helpDto.title}"></td>
	  			</tr>
	  		 	<tr>
	  				<td><textarea type="text" class="form-control" name="content" maxlength="3000" style="height:400px;">${map.helpDto.content }</textarea></td>
	  			</tr>
	 			<tr> 
	 			 	<td><input type="text" class="form-control"  name="points" maxlength="10" value="${map.helpDto.points }"></td>
	 			</tr>
	 			<tr> 
	  				<td><input type="text" class="form-control"  name="location" maxlength="10" value="${map.helpDto.location }"></td>
	 			</tr>
	 			<tr>
