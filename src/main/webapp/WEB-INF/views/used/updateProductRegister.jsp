...
<div class="container mt-5">
    ...
    <div class="col-2"></div>
    <div class="col">
    <form action="./updateProductRegisterProcess" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row mt-3">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="content" rows="5" placeholder="상품 설명">${map.productDto.content }</textarea>
            </div>
        </div>
        ...
        <div class="form-group row mt-3">
            ...
            <div class="col-4">
             	<input class="form-control" type="text" name="location" value="${map.productDto.location }"> 
            </div>
            <div class="col-4">
        ...
        <div class="row">
            ...
            <div class="col-2 me-0 d-grid">
                <a href="./productDetail?productId=${map.productDto.id }" type="button" class="btn btn-primary btn-block btn-dark">이전</a>
            </div>
            <div class="col-2 me-0 d-grid">
