    ...
    <div class="col ms-5">
		...
		<div class="row mt-4 align-bottom px-0 mb-4">
	    	...
	    	<a href="./deleteProduct?productId=${map.productDto.id }" type="button" class="btn btn-outline-secondary btn-sm">삭제</a>
	    		...
	    		<c:if test="${completeCount > 0}">
	    			<div class="col text-end my-auto pe-0"><button class="btn btn-sm fw-semibold btn-secondary" style="padding: 6px 25px;font-size: 16px;" onclick="reloadChatRoomList()">대화 중인 채팅방 1</button></div>
	    		</c:if>
	    		<c:if test="${completeCount == 0}">
