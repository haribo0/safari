...
<body>
	...
	<div class="container mb-5 py-4 border-top"> 
		...
		<div class="row mt-3">
			...
			<div class="col">
				<p>${data.rentalBusinessDto.business_name}<p>
				<div class="pe-5">
					...
					<div class="d-flex justify-content-between">
						<div class="row">
 						...
 						<p>
							<span class="me-4">${reviewRating}</span> <span>리뷰 ${reviewCount}</span>
						</p>
					...
					<div>
						<div>
							<p class="">*보증금 <fmt:formatNumber value="${data.rentalItemDto.deposit}" pattern="#,##0" />원</p>
						</div>
