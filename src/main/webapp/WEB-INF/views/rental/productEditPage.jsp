...
<div class="container mt-5">
    ...
    <div class="col ms-5">
    <h4 class="row mt-3 mb-4 fw-regular">대여 상품 수정</h4>
    <form action="./productUpdateProcess" id="frm" method="POST" enctype="multipart/form-data">
        <div class="form-group row mt-1">
            <div class="col-10">
            	<div class="mb-1"><label for="title" class="col-form-label fw-medium">상품 제목</label></div>
                <input type="text" class="form-control" id="title" name="title" value="${map.product.title}">
            </div>
        </div>
        ...
        <div class="form-group row mt-3">
            ...
            <div class="mb-1"><label for="description" class="col-form-label fw-medium">상품 설명</label></div>
                <textarea class="form-control" id="description" name="item_description" rows="5" >${map.product.item_description}</textarea>
            </div>
        </div>
        ...
        <div class="form-group row mt-3">
            <div class="col">
                ...
                <input type="text" class="form-control" id="deposit" name="deposit" value="${map.product.deposit}">
            </div>
            <div class="col">
            	<div class="mb-1"><label for="price" class="col-form-label fw-medium">대여 가격 (월)</label></div>
                <input type="text" class="form-control" id="price" name="price" value="${map.product.price}">
            </div>
            <div class="col">
            	<div class="mb-1"><label for="quantity" class="col-form-label fw-medium">총 운영 수량</label></div>
                <input type="text" class="form-control" id="quantity" name="quantity" value="${map.product.quantity}">
            </div>
            <div class="col-2">
            </div>
        </div>
       ...
       <div class="form-group row mt-3">
            <div class="col-10">
            	...
            	<div class="form-group row mt-2" id="disc_form">
		        	<div class="row ">
		            	<label for="mon12" class="col-1 col-form-label-sm text-end mt-1">12개월</label>
			            <div class="col-3">
			                <input type="text" class="form-control disc_price" id="mon12" name="discountedPrice" placeholder="가격">
			            </div>
		            	<label for="mon24" class="col-1 col-form-label-sm text-end mt-1">24개월</label>
			            <div class="col-3">
			                <input type="text" class="form-control disc_price" id="mon24" name="discountedPrice" placeholder="가격">
			            </div>
		            	<label for="mon36" class="col-1 col-form-label-sm text-end mt-1">36개월</label>
			            <div class="col-3">
        ...
        <div class="row mt-5">
            ...
            <div class="col-2 me-0 d-grid">
                <button type="submit" class="btn btn-primary btn-block btn-dark">수정</button>
            </div>
        </div>
    </form>
    </div>
