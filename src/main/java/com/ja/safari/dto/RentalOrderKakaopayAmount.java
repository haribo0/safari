...
public class RentalOrderKakaopayAmount {
	...
	public RentalOrderKakaopayAmount() {
		super();
	}
	

	public RentalOrderKakaopayAmount(int id, int total, int tax_free, int vat, int point, int discount,
			int green_deposit) {
		super();
		this.id = id;
		this.total = total;
